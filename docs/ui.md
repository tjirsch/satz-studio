...
step 15 sends one, on a Claude credential or a signed-in Claude Code. Nothing in the walk changes a live
...
15. **The debug log.** On the fixture estate, with the debug log off: Chat → "which

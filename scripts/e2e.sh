...
# tests/e2e_interview.rs, tests/e2e_map.rs, tests/e2e_edit.rs, tests/e2e_import.rs and
# tests/e2e_answer_shapes.rs, each creating its own temporary estate over vendor/satz. No live import runs: the

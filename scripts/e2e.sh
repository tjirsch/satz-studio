...
# tests/e2e_answer_shapes.rs, tests/e2e_pack_edges.rs, tests/e2e_notices.rs and
# tests/e2e_review.rs, each creating its own temporary estate over vendor/satz, and
# tests/e2e_export.rs, which
